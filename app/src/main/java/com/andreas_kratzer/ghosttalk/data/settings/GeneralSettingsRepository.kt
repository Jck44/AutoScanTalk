...
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_APP_LANGUAGE
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_DEFAULT_START_PAGE_ID
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_FAVORITE_BOOK_ID
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_PAGE_SORT_ORDER
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_STARTUP_BEHAVIOR
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_TEMPLATE_SORT_ORDER
import com.andreas_kratzer.ghosttalk.data.settings.SettingsConstants.KEY_THEME_MODE
