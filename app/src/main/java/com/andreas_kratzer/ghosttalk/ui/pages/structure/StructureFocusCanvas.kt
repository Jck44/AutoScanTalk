    ...
    Column(
        ...
        ElevatedCard(
            ...
            Column(modifier = Modifier.padding(16.dp)) {
                ...
                val validButtons = remember(page) {
                    page.buttonConfigs.filter { it != null && it.isActive && it.label.isNotBlank() }
                }
                            ...
                            SuggestionChip(
                                ...
                                label = {
                                    Column {
                                        ...
                                        Text(
                                            text = "über Button: \"${page.buttonConfigs.getOrNull(edge.sourceButtonIndex)?.label ?: ""}\"",
