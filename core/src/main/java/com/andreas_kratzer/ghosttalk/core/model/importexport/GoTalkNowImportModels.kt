...
data class ImportExportData(
    ...
    val isVocalSwitchEnabled: Boolean? = null,
    val monitoredNotificationApps: List<String>? = null,
    val autoReadMode: String? = null,
    val autoReadOnlyInUserMode: Boolean? = null,
    val autoReadInStandby: Boolean? = null,
    val showPageIdInLog: Boolean? = null,
    val bluetoothDelay: Long? = null,
    val lateClickThresholdMillis: Long? = null,
