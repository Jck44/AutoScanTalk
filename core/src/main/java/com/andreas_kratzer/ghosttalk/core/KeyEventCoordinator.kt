...
class KeyEventCoordinator @Inject constructor(
    private val keyEventSettings: KeyEventSettings
) {
    /**
    ...
    fun shouldActivate(event: KeyEvent, isUserMode: Boolean): Boolean {
        ...
        val volumeActivate = keyEventSettings.volumeKeysActivate
        val switchKey = keyEventSettings.switchActivationKey.trim()
