...
class TemplateRepositoryImpl @Inject constructor(
    ...
    override fun getAllTemplates(): Flow<List<PageTemplate>> {
        return templateDao.getAllTemplatesFlow()
    }

    override suspend fun getById(id: String): PageTemplate? {
        return templateDao.getTemplateById(id)
    }

    override suspend fun insert(template: PageTemplate) {
    ...
    override suspend fun duplicateTemplate(templateId: String, duplicateSuffix: String): String? {
