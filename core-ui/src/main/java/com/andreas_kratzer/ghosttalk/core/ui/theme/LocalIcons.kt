    ...
    val Undo: ImageVector
        get() = materialIcon(name = "AutoMirrored.Filled.Undo", autoMirror = true) {
            materialPath {
                ...
                quadToRelative(1.575f, 0.0f, 2.7375f, -1.0f)
                reflectiveQuadTo(18.0f, 13.5f)
                quadToRelative(0.0f, -1.5f, -1.1625f, -2.5f)
                reflectiveQuadTo(14.1f, 10.0f)
                ...
                quadToRelative(2.425f, 0.0f, 4.1625f, 1.575f)
                reflectiveQuadTo(20.0f, 13.5f)
                quadToRelative(0.0f, 2.35f, -1.7375f, 3.925f)
                reflectiveQuadTo(14.1f, 19.0f)
                horizontalLineTo(7.0f)
                close()
            }
        }
    ...
    val Redo: ImageVector
        get() = materialIcon(name = "AutoMirrored.Filled.Redo", autoMirror = true) {
            materialPath {
                moveTo(9.9f, 19.0f)
                quadToRelative(-2.425f, 0.0f, -4.1625f, -1.575f)
                reflectiveQuadTo(4.0f, 13.5f)
                quadToRelative(0.0f, -2.35f, 1.7375f, -3.925f)
                reflectiveQuadTo(9.9f, 8.0f)
                horizontalLineToRelative(6.3f)
                lineTo(13.6f, 5.4f)
                lineToRelative(1.4f, -1.4f)
                lineToRelative(5.0f, 5.0f)
                ...
                quadToRelative(-1.575f, 0.0f, -2.7375f, 1.0f)
                reflectiveQuadTo(6.0f, 13.5f)
                quadToRelative(0.0f, 1.5f, 1.1625f, 2.5f)
                reflectiveQuadTo(9.9f, 17.0f)
                horizontalLineToRelative(7.1f)
                verticalLineToRelative(2.0f)
                horizontalLineTo(9.9f)
                close()
